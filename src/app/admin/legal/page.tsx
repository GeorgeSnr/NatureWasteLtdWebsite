...
export default function AdminLegalPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            target="_blank"
            className="px-3.5 py-2 rounded-sm border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-bold text-xs uppercase tracking-wider transition-colors flex items-center gap-1.5 shadow-2xs"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-sm border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-bold text-xs uppercase tracking-wider transition-colors flex items-center gap-1.5 shadow-2xs cursor-pointer"
          >
          ...
          <button
            ...
            disabled={loading}
            className="bg-[#006F51] hover:bg-[#005a42] disabled:bg-gray-400 text-white px-5 py-2 rounded font-bold text-xs uppercase tracking-wider transition-colors shadow-xs flex items-center gap-2 cursor-pointer"
          >
      ...
      {saveSuccess && (
        <div className="p-4 bg-emerald-50 border border-emerald-300 text-emerald-800 rounded text-xs font-bold flex items-center gap-2 shadow-2xs">
      ...
      {saveError && (
        <div className="p-4 bg-red-50 border border-red-300 text-red-800 rounded text-xs font-bold flex items-center gap-2 shadow-2xs">
      ...
      <div className="bg-white p-2 rounded border border-[#E5E7EB] shadow-xs flex items-center gap-2">
        <button
          onClick={() => {
            setActiveTab("privacy_policy");
            setSaveSuccess(null);
          }}
          className={`flex-1 py-2.5 px-4 rounded-sm font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer text-center flex items-center justify-center gap-2 ${
      ...
      <div className="bg-white p-6 rounded border border-[#E5E7EB] shadow-xs space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="sm:col-span-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-sm text-xs font-bold text-gray-900 focus:outline-none focus:border-[#006F51]"
            />
          </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-sm text-xs text-gray-800 focus:outline-none focus:border-[#006F51]"
          />
        </div>
      </div>
      ...
      {previewMode ? (
        /* Preview Mode */
        <div className="bg-white rounded border border-[#E5E7EB] p-8 shadow-xs space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-emerald-50 border border-emerald-300 text-emerald-800 hover:bg-emerald-100 rounded-sm text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
            >
          ...
          {currentDoc.sections.map((sec, idx) => (
            <div
              key={idx}
              className="bg-white rounded border border-[#E5E7EB] shadow-xs p-5 space-y-3"
            >
              <div className="flex items-center justify-between gap-3">
                <input
                  ...
                  className="w-full px-3 py-1.5 bg-gray-50 border border-gray-300 rounded-sm text-xs font-bold text-gray-900 focus:outline-none focus:border-[#006F51]"
                />
                <button
              ...
              <div>
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-sm text-xs text-gray-800 leading-relaxed focus:outline-none focus:border-[#006F51]"
                />
              </div>
            </div>
          ))}
          ...
          <div className="pt-2 flex justify-end">
            <button
              onClick={handleSaveToNeon}
              disabled={loading}
              className="bg-[#006F51] hover:bg-[#005a42] disabled:bg-gray-400 text-white px-6 py-3 rounded font-bold text-xs uppercase tracking-wider transition-colors shadow-xs flex items-center gap-2 cursor-pointer"
            >
              {loading ? <RefreshCw className="w-4 h-4 animate-spin" /> : <Save className="w-4 h-4" />}

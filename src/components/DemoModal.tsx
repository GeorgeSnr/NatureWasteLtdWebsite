...
export default function DemoModal({ isOpen, onClose }: DemoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/75">
      <div className="relative w-full max-w-3xl bg-[#181A1C] text-white rounded border border-white/20 shadow-xl overflow-hidden">
        {/* Modal Header */}
        ...
        <div className="relative w-full aspect-video bg-gray-950 flex flex-col items-center justify-center p-6 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg space-y-4">
            <div className="w-16 h-16 rounded-full bg-[#006F51] text-white flex items-center justify-center mx-auto border border-white/30 shadow-md">
        ...
        {/* Footer Actions */}
        <div className="p-5 bg-[#202225] flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/10">
          ...
          <a
            href="/book-demo"
            onClick={onClose}
            className="bg-[#FFCE00] hover:bg-[#E5B800] text-[#1A1D20] px-6 py-2.5 rounded font-bold text-xs uppercase tracking-wider transition-colors inline-block"
          >

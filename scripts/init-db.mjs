...
async function init() {
  ...
  const seedUsers = [
    {
      ...
      eco_points: 340,
      assigned_bin_id: "BIN-103",
      latitude: 0.2528,
      longitude: 32.5621,
      location_address: "Lubowa Quality Hill, Entebbe Corridor, Wakiso",
    },
    {
      id: "USR-C-102",
    ...
    },
    {
      ...
      account_status: "active",
      eco_points: 890,
      assigned_bin_id: "BIN-104",
      latitude: 0.3245,
      longitude: 32.5802,
      location_address: "Nakasero Medical Hub, Kampala",
    },
    {
      id: "USR-C-104",
      name: "Grace Kigozi",
      ...
      suburb: "Kitende",
      address: "Karl House Enclave, Plot 8B",
      plan: "Residential Connect (120L)",
      account_status: "active",
      eco_points: 190,
      assigned_bin_id: "BIN-101",
      latitude: 0.2189,
      longitude: 32.5314,
    ...
    },
    {
      ...
      email: "geoffrey@naturewaste.ug",
      phone: "+256 766 532 915",
      role: "admin",
      organization: "Nature Waste Ltd HQ",
      suburb: "Kitende",
      address: "Karl House, Room 9, Entebbe Road",
      plan: "Operations SuperAdmin",
      account_status: "active",
      eco_points: 0,
      latitude: 0.2215,
      longitude: 32.5342,
    ...
    },
    {
      ...
      email: "dispatch@naturewaste.ug",
      phone: "+256 700 488 477",
      role: "dispatcher",
      organization: "Nature Waste Ltd",
      suburb: "Kajjansi",
      address: "Entebbe Highway Junction Base",
      plan: "Fleet Routing Supervisor",
      account_status: "active",
      eco_points: 0,
      latitude: 0.2155,
      longitude: 32.5298,
      location_address: "Kajjansi Clays Roundabout, Wakiso",
    },
  ];
  ...
  for (const u of seedUsers) {
    await sql`
      INSERT INTO users (
        id, name, email, phone, role, organization, suburb, address, plan, account_status, eco_points, assigned_bin_id, latitude, longitude, location_address
      ) VALUES (
        ${u.id}, ${u.name}, ${u.email}, ${u.phone}, ${u.role}, ${u.organization}, ${u.suburb}, ${u.address}, ${u.plan}, ${u.account_status}, ${u.eco_points}, ${u.assigned_bin_id || null}, ${u.latitude}, ${u.longitude}, ${u.location_address}
      )
